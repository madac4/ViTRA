...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const profileItem = document.querySelectorAll('.history__item');
    ...
    if (w <= 640) {
        ...
        const mobileSortToggler = document.querySelector(
            '.product-sort--mobile .product-sort__header button',
        );
    ...
    function productSliders() {
        if (products[0]) {
            products.forEach((product) => {
                ...
                const productPaginationItem =
                    productPagination.querySelectorAll('.pagination-item');
    ...
    if (
        ...
        document.querySelector('.prost-article__title')
    ) {
        Ellipsis({
    ...
    const tabsLoginHandler = (path) => {
        ...
        document
            ...
            .classList.add('login-tabs__button--active');
        ...
        document
            .querySelector(`[data-tabs-target="${path}"]`)
            .classList.add('login-tabs__content--active');
    };
